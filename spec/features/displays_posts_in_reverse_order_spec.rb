...
RSpec.feature "Timeline", type: :feature do
  scenario "posts are displayed in reverse order with user name, message and timestamp" do
    sign_up
    create_new_post
    ...
    expect(page.find('.posts-index-posts li:first-child')).to have_content("Barney Test")
